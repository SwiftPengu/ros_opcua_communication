...
# Install support for POC messages until we have time to create generic solution
RUN apt-get install -y ros-melodic-gazebo-msgs ros-melodic-moveit-msgs ros-melodic-controller-manager-msgs ros-melodic-tf2-msgs ros-melodic-control-msgs
